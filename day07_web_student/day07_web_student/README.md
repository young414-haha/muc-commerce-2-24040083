...
- 姓名：袁艳
- 学号：24040083
- 专题方向：PreferredOrderCat
- 已完成功能：1. 登录闭环：使用 student/day07 演示账号2. 数据看板：4张指标卡（总用户数5,630、流失用户948、总体流失率16.8%、平均订单数2.96）3. 品类筛选：支持下拉筛选，动态更新表格4. 离线问答：支持5类问题（用户数、流失率、偏好品类、生命周期、订单数）
- 选择的拓展任务：A
- 拓展访问或运行方法：在数据看板页面，点击「导出CSV」按钮，浏览器会自动下载当前筛选的品类数据
